...
def baner():
    ...
    print(f"""
   {warna}╔═╗{W}┌─┐┌─┐┌┬┐  {warna}╦ ╦{W}┌─┐
   {warna}╚═╗{W}├─┘├─┤│││  {warna}║║║{W}├─┤ V{warna}1.0
   {warna}╚═╝{W}┴  ┴ ┴┴ ┴  {warna}╚╩╝{W}┴ ┴ """)
    print("   "+Back.WHITE+BL+"|Author : FERNANDA A.            |\033[00m")
    print("   "+Back.WHITE+BL+"|Youtube: Am Project             |\033[00m")
    print("   "+Back.WHITE+BL+"|Github : github.com/FR-nanda1605|\033[00m")
